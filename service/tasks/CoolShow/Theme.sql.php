...
defined("SQL_SELECT_THEME_INFO")
	or define("SQL_SELECT_THEME_INFO", "SELECT pay.*, 
											 rule.ruleid AS ruleid, rule.score AS score, incrule.ruleid AS incruleid, incrule.score AS incscore, 
											 dl.download_times, 
											 ad.ad, ad.adurl, ad.adicon, 
											 t.ischarge, t.cpid, t.name, t.pre_url, t.pre_icon, t.pre_mms, t.pre_contact,  
											 t.note, t.author, t.cyid AS userid, 
											 t.intro,  t.star_level,
											 tinfo.size,  
											 tinfo.identity, tinfo.kernel, tinfo.height, tinfo.width,
											 ...
											 WHERE t.valid = 1 AND tinfo.valid = 1 AND tinfo.width = %d AND tinfo.height = %d %s 
											 %s LIMIT %d, %d  ");
